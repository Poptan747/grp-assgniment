    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: (Text(
          'Cincai lah~',
          style: TextStyle(
              color: Colors.black, fontFamily: 'DancingScript', fontSize: 40),
        )),
        leading: InkWell(
            onTap: () {
              Navigator.push(
            ...
            child: const Icon(Icons.history, color: Color(0xfff55951))),
        actions: [
          Padding(
              ...
              child: IconButton(
                ...
                icon: Icon(Icons.bar_chart, color: Color(0xfff55951)),
              )),
        ],
      ),
